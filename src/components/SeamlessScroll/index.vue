...
function refreshChildNodesCount() {
  if (!topRef.value)
    return
...
<template>
  <div class="seamless-scroll">
    <div ref="wrapperRef" class="seamless-scroll__wrapper" @mouseover="onMouseOver" @mouseout="onMouseOut">
      <div
        ref="boxRef"
        class="seamless-scroll__box" :class="{ 'seamless-scroll__box--odd': isChildNodesOdd, 'seamless-scroll__box--even': !isChildNodesOdd }"
      >
        <div ref="topRef" class="seamless-scroll__box-top">
          <slot />
        </div>
